            ...
            <a href="#home" className="footer-logo">
              <div className="footer-logo-mark">
                <svg viewBox="0 0 58 52" fill="none" xmlns="http://www.w3.org/2000/svg">
                  ...
                  <rect x="0" y="18" width="16" height="6" rx="1" className="footer-logo-hammer"/>
                  {/* Hammer handle - angled down */}
                  <rect x="12" y="22" width="4" height="18" rx="1" className="footer-logo-hammer" transform="rotate(-20 14 31)"/>
                </svg>
              </div>
